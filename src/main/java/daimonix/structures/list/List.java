...
public interface List<T> extends Iterable<T> {
    ...
    /**
     * Returns first element in list or throws NullPointerException if list is
     * empty.
     * 
    ...
    /**
     * Returns element in list with specified index, throws NullPointerException if
     * list is empty or IndexOutOfBoundsException if index is outside of list
     * bounds.
     * 
